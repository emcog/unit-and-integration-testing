...
portypy
/
Unit-and-Integration-Testing-PDA
1
0
0
Code
...
Security
Insights
Unit-and-Integration-Testing-PDA/src/App.vue
@portypy
portypy initial commit
Latest commit b90f415 22 days ago
History
1 contributor
153 lines (139 sloc)  3.46 KB
...
export default {
  ...
  methods: {
    ...
    divide(number) {
      if (number == 0)
        this.runningTotal = 'Error, can not divide by 0';
      else
        this.runningTotal = parseFloat(this.previousTotal) / parseFloat(number);
    },
  },
